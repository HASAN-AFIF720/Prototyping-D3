...
| `Diagrams_Old/` | Earlier diagram revisions (archived) |
...
| `IBD.drawio.pdf` | Internal Block Diagram (draw.io export) |
| `Sequence_Diagram.png`, `Use_Case.png` | Root-level diagram exports |
...
| Internal Block Diagram | `IBD.drawio.pdf` |
